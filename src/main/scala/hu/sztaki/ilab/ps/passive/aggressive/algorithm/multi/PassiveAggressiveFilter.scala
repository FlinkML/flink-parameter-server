package hu.sztaki.ilab.ps.passive.aggressive.algorithm.multi
...
abstract class PassiveAggressiveFilter(rho :(Int, Int) => Double) extends Serializable {

  def Rho = rho

  protected def q: Double
