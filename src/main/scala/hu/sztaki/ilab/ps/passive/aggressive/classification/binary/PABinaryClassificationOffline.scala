package hu.sztaki.ilab.ps.passive.aggressive.classification.binary
...
class PABinaryClassificationOffline


object PABinaryClassificationOffline {

  private val log = LoggerFactory.getLogger(classOf[PABinaryClassificationOffline])
